locals {
  ...
  default_security_group_ingress_rule_cidrs = local.raw_default_security_group_ingress_rule_cidrs == null ? [data.aws_vpc.vpc.cidr_block] : local.raw_default_security_group_ingress_rule_cidrs
  default_security_group_egress_rule_cidrs = local.raw_default_security_group_egress_rule_cidrs == null ? [data.aws_vpc.vpc.cidr_block] : local.raw_default_security_group_egress_rule_cidrs
